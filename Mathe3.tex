...
(Multiplikation entspricht der Matrixmultiplikation\index{Matrixmultiplikation} und ist nicht möglich falls $n > 1$)
\end{minipage}\\
...
\Nameref{sec:1.5} d): Die bijektiven Abbildung, $ M \longrightarrow M$ bilden bezüglich $\circ$ eine Gruppe
\end{enumerate}
\printindex
\end{document}